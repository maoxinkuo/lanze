...
<div class="alltop_nav" id="nav">
	<div class="tnav">
  		<div class="tlogo"><a href="/ls/"><img src="<?php if(C('qscms_logo_other')): echo attach(C('qscms_logo_other'),'resource'); else: ?>__HOMEPUBLIC__/images/logo_other.png<?php endif; ?>" border="0"/></a></div>
		<div class="tl">
			<ul class="link_gray6 nowrap">
				<?php $tag_nav_class = new \Common\qscmstag\navTag(array('列表名'=>'nav','调用名称'=>'QS_top','数量'=>'10','cache'=>'0','type'=>'run',));$nav = $tag_nav_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("title"=>"HR工具箱","keywords"=>"","description"=>"","header_title"=>""),$nav);?>
...
<div class="hr_nav">
     <div class="txt link_gray6"><a href="<?php echo url_rewrite('QS_index');?>">网站首页</a><span>></span><a href="<?php echo url_rewrite('QS_hrtools');?>">HR工具箱</a></div>
</div>

<div class="hrlistbox">
<div class="list">  
    <div class="l"><img src="<?php echo attach('hr.jpg','resource/hrtools_img');?>" /></div>
	<div class="r link_blue">
	  <div class="tit">
  		<a href="http://www.hrcha.cn" target="_blank">职场信用查询</a>
	  </div>
	  <div class="clear"></div>
	  <div class="txt"><strong>HRcha.cn</strong>提供职场信用查询致力于让职场环境更和谐，更健康。欢迎HR上传无职业道德的”极品员工“共建和谐职场环境。 <a href="http://www.hrcha.cn" target="_blank">查看>></a></div>
	</div>
    <div class="clear"></div>
  </div>
<?php $tag_hrtools_category_class = new \Common\qscmstag\hrtools_categoryTag(array('列表名'=>'category','cache'=>'0','type'=>'run',));$category = $tag_hrtools_category_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("title"=>"HR工具箱","keywords"=>"","description"=>"","header_title"=>""),$category);?>
<?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list">  
    <div class="l"><img src="<?php echo ($vo['img']); ?>" /></div>
	<div class="r link_blue">
	  <div class="tit">
  		<a href="<?php echo ($vo['url']); ?>"><?php echo ($vo['c_name']); ?></a>
	  </div>
	  <div class="clear"></div>
	  <div class="txt"><?php echo ($vo['c_desc']); ?>  <a href="<?php echo ($vo['url']); ?>">更多>></a></div>
	</div>
    <div class="clear"></div>
...
<div class="footer_min" id="footer">
	...
	<?php $tag_explain_list_class = new \Common\qscmstag\explain_listTag(array('列表名'=>'list','cache'=>'0','type'=>'run',));$list = $tag_explain_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("title"=>"HR工具箱","keywords"=>"","description"=>"","header_title"=>""),$list);?>
