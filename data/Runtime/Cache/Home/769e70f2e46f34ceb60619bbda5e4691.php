...
<div class="index_head">
	<div class="logobox">
		<a href="/ls/"><img src="<?php if(C('qscms_logo_home')): echo attach(C('qscms_logo_home'),'resource'); else: ?>../public/images/logo.gif<?php endif; ?>" border="0"/></a>
	...
	<div class="sobox">
	    ...
	    <div class="righttxt link_gray6"><a href="<?php echo url_rewrite('QS_jobs');?>">分类搜索</a> <a href="<?php echo url_rewrite('QS_map');?>" class="map">地图找工作</a></div>
	</div>
...
<div class="index_nav_bg">
  <div class="index_nav">
    <ul class="link_gray6 nowrap">
    	<?php $tag_nav_class = new \Common\qscmstag\navTag(array('列表名'=>'nav','调用名称'=>'QS_top','数量'=>'10','cache'=>'0','type'=>'run',));$nav = $tag_nav_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("title"=>"骑士PHP高端人才系统(www.74cms.com)","keywords"=>"骑士人才系统，74cms，骑士cms，人才网站源码，php人才网程序","description"=>"骑士CMS是基于PHP+MYSQL的免费网站管理系统，提供完善的人才招聘网站建设方案","header_title"=>""),$nav);?>
...
<div class="index_7">
    ...
    <div class="nl">
	  	<div class="topnavbg">
			<div class="topnav">
				<?php $tag_classify_class = new \Common\qscmstag\classifyTag(array('列表名'=>'article_category','类型'=>'QS_article','id'=>'1','cache'=>'0','type'=>'run',));$article_category = $tag_classify_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("title"=>"骑士PHP高端人才系统(www.74cms.com)","keywords"=>"骑士人才系统，74cms，骑士cms，人才网站源码，php人才网程序","description"=>"骑士CMS是基于PHP+MYSQL的免费网站管理系统，提供完善的人才招聘网站建设方案","header_title"=>""),$article_category);?>
	    ...
	    <div class="newsbox J_news_content">
			...
			<div class="J_news_txt">
				<?php $tag_news_list_class = new \Common\qscmstag\news_listTag(array('列表名'=>'article_list','显示数目'=>'15','资讯小类'=>'2','cache'=>'0','type'=>'run',));$article_list = $tag_news_list_class->run();$frontend = new \Common\Controller\FrontendController;$page_seo = $frontend->_config_seo(array("title"=>"骑士PHP高端人才系统(www.74cms.com)","keywords"=>"骑士人才系统，74cms，骑士cms，人才网站源码，php人才网程序","description"=>"骑士CMS是基于PHP+MYSQL的免费网站管理系统，提供完善的人才招聘网站建设方案","header_title"=>""),$article_list);?>
...
Powered by <a href="http://www.74cms.com">74cms</a> v<?php echo (QSCMS_VERSION); ?> 迅易科技版权所有<br />
...
<?php if($apply['Subsite']): ?><script id="J-sub-dialog-content" type="text/html">
		<div class="sub-dialog-group">
	        ...
	        <div class="sdg-sub-city-group">
	        	<?php if(is_array($district)): $i = 0; $__LIST__ = array_slice($district,0,10,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$district): $mod = ($i % 2 );++$i;?><a href="<?php echo U('subsite/set',array('sid'=>$district['s_id']));?>" class="sdg-sub-city"><?php echo ($district["s_sitename"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
	        	<?php if(count($district_list) > 11): ?><a href="<?php echo U('subsite/index');?>" class="sdg-sub-city more">更多地区</a><?php endif; ?>
	            <div class="clear"></div>
	        </div>
