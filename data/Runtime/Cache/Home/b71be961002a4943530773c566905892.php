 ...
 <!-- -->
			...
			<div class="mright">
				...
				<?php if(!empty($jobs_list['list'])): ?><form id="form1" action="<?php echo U('jobs_perform');?>" class="J_allListBox" method="post">
					<div class="jobsWrap">
						<?php if(is_array($jobs_list['list'])): $i = 0; $__LIST__ = $jobs_list['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$jobs): $mod = ($i % 2 );++$i; if($jobs['display'] == 2 || $jobs['audit'] == 3): ?><div class="jobsList">
									<div class="selWrap">
									...
									<div class="status <?php if($jobs['audit'] == 2): ?>font_yellow<?php else: ?>font_red<?php endif; ?> fl"><?php echo ($jobs["status_cn"]); ?></div>
