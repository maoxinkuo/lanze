...
<script>
	var URL = '/ls/index.php/Admin/Jobs',
		SELF = '/ls/index.php?m=Admin&amp;c=Jobs&amp;a=index',
  ...
  <div class="seltpye_y">
    ...
    <div class="list">
      ...
      <div class="txt link_lan">
		...
		<?php if($_GET['jobtype']!= '0'): ?><a href="<?php echo P(array('audit'=>'3'));?>" <?php if($_GET['audit']== '3'): ?>class="select"<?php endif; ?>>审核未通过<span>(<?php echo ($count[5]); ?>)</span></a><?php endif; ?>
      </div>
    </div>
