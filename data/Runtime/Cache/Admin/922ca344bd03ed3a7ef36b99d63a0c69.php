...
<script>
	var URL = '/ls/index.php/Admin/Notice',
		SELF = '/ls/index.php?m=Admin&amp;c=Notice&amp;a=index',
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" id="list" class="link_lan">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
              <td  class="admin_list admin_list_first">
                ...
                <a href="<?php echo ($list['url']); ?>" target="_blank" style="<?php if($list['tit_color']): ?>color:<?php echo ($list["tit_color"]); ?>;<?php endif; if($list['tit_b'] > 0): ?>font-weight:bold<?php endif; ?>"><?php echo ($list["title"]); ?></a>
