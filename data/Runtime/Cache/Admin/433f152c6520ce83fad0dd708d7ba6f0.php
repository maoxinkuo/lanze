...
<script>
	var URL = '/ls/index.php/Admin/Personal',
		SELF = '/ls/index.php?m=Admin&amp;c=Personal&amp;a=index',
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td align="center"  class="admin_list">
          ...
          <td align="center"  class="admin_list">
            ...
            &nbsp;
            <a class="userinfo"  href="<?php echo U('Personal/resume_delete',array('id'=>$vo['id']));?>" onClick="return confirm('您确定删除吗?')">删除</a>
            &nbsp;
