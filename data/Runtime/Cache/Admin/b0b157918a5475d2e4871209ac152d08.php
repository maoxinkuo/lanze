...
<script>
	var URL = '/ls/index.php/Admin/Company',
		SELF = '/ls/index.php?m=Admin&amp;c=Company&amp;a=index',
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0"  id="list" class="link_lan">
     ...
     <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr >
        <td class="admin_list admin_list_first" >
		 ...
		 <?php if($vo['audit'] == 1): ?>&nbsp;<span style="color: #009900" title="已认证惬意">[证]</span><?php endif; ?>
        ...
        <td align="center" class="admin_list">
          <?php echo (date("m-d h:i",$vo['addtime'])); ?>
        </td>
        <td align="center" class="admin_list">
          <?php echo (date("m-d  h:i",$vo['refreshtime'])); ?>
        </td>
        <td align="center" class="admin_list">
...
$(document).ready(function()
{
  ...
  $("#set_audit_famous").live('click',function(){
      $("form[name=form1]").attr("action","<?php echo U('company/com_audit_famous');?>");
      $("form[name=form1]").submit()
  });
