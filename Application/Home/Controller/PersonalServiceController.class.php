    ...
    */
    ...
    public function increment_add($cat=''){
        ...
        switch($cat){
            case 'stick':
                ...
                $this->assign('resume',D('Resume')->where(array('uid'=>$this->uid,'audit'=>array('neq',3),'display'=>1))->getField('id,title,stick'));
            ...
            case 'tag':
                ...
                $this->assign('resume',D('Resume')->where(array('uid'=>$this->uid,'audit'=>array('neq',3),'display'=>1))->getField('id,title,strong_tag'));
    ...
    public function check_weixinpay_notify(){
        if(file_exists(QSCMS_DATA_PATH.'wxpay/'.$_SESSION['wxpay_no'].'.tmp')){
            ...
            $this->ajaxReturn(1,'回调成功',U('user_order_list'));
        }
    }
    /**
     * 取消订单
