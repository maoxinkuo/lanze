...
class CategoryJobsController extends BackendController {
    ...
    public function index(){
        ...
        $jobs = $this->_mod->field('id,parentid,categoryname,category_order,spell')->where(array('parentid'=>$pid))->order('category_order,id')->select();
    ...
    public function add(){
        ...
        if(IS_POST){
            ...
            $cate = $this->_mod->field('id,parentid,categoryname,category_order')->order('category_order,id')->select();
