...
class PageController extends BackendController{
    ...
    public function rewrite(){
        ...
        $normal = array(
            ...
            'explain' => '说明',
            'versions' => QSCMS_VERSION,
            'update_time' => QSCMS_RELEASE,
            'author' => '74cms'
        );
    ...
    public function rewrite_set(){
        ...
        if(!is_writable(CONF_PATH.'url.php')){
            $this->error('请为该文件设置读写权限“./74cms40new/Application/Common/Conf/url.php”');
        }
        if($type == 'normal'){
        ...
        if($url) $sys_url = array_merge($sys_url,$url);
