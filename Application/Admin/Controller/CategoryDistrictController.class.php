...
class CategoryDistrictController extends BackendController {
    ...
    public function index(){
        ...
        $district = $this->_mod->field('id,parentid,categoryname,category_order,spell')->where(array('parentid'=>$pid))->order('category_order,id')->select();
    ...
    public function add(){
        ...
        if(IS_POST){
            ...
            $province = $this->_mod->field('id,parentid,categoryname,category_order')->order('category_order,id')->select();
