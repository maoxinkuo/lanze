	...
	public function run(){
		if(C('qscms_com_unlogin_remind_open')==1 || C('qscms_per_unlogin_remind_open')==1){
			if(C('qscms_com_unlogin_remind_open')==1){
				...
				$html_resume .='</ul>
				                <a target="_blank" style="float:right; text-decoration:underline; font-weight:700; margin:15px 0;color:#017FCF;" href="'.C('qscms_site_domain').url_rewrite('QS_resumelist').'">查看所有简历</a>
				            </td>
				        </tr>';
				$html_resume .='
				        <tr>
			...
			if(C('qscms_per_unlogin_remind_open')==1){
				...
				$html_jobs .='</ul>
				                <a target="_blank" style="float:right; text-decoration:underline; font-weight:700; margin:15px 0;color:#017FCF;" href="'.C('qscms_site_domain').url_rewrite('QS_jobslist').'">查看所有职位</a>
				            </td>
				        </tr>';
				$html_jobs .='
				        <tr>
