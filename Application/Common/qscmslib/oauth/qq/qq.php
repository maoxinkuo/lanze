...
class qq_oauth
{
    ...
    public function __construct($setting) {
        ...
        if(C('PLATFORM') == 'mobile'){
            $this->redirect_uri = C('qscms_site_domain').$dir.U('mobile/callback/oauth', array('mod'=>'qq'),'',false,true);
        }else{
            $this->redirect_uri = C('qscms_site_domain').$dir.U('callback/oauth', array('mod'=>'qq'),'',false,true);
        }
