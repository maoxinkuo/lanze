...
class CompanyImgModel extends Model
	{
		 ...
		 * 审核
		 */
		public function set_audit($id,$audit,$reason,$pms_notice='1'){
			...
			if (fieldRegex($sqlin,'in'))
			{
				...
				// 		$setsqlarr['message']="您上传的图片，标题为：{$value['title']},".$note." 其他说明：".$reason;
				// 		$setsqlarr['msgtype']=1;
				...
				// 	}
				// }
				admin_write_log("将企业图片id为".$sqlin."的图片,认证状态设为".$audit, C('visitor.username'),3);
			}
			return $return;
		}
	}
