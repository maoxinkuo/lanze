...
class CategoryDistrictModel extends Model
{
	...
	public function custom_district_cache(){
		$district = array();
		$districtData = $this->field('id,parentid,categoryname,spell')->order('category_order asc')->select();
	...
	public function district_cache(){
		$district = array();
		$districtData = $this->field('id,parentid,categoryname')->order('category_order asc')->select();
		foreach ($districtData as $key => $val) {
	...
	public function city_cate_cache(){
		$citySpell = $this->order('parentid asc')->getfield('spell,id,parentid,categoryname');
