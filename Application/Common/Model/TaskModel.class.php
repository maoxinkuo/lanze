...
class TaskModel extends Model{
	    ...
	    public function task_cache() {
	        $task = $this->getField('id,title,points,once,becount,times,t_alias,utype');
	        F('task', $task);
	        return $task;
	    }
	    /**
	    ...
	    public function task_url($utype=1){
	    	...
	    	$data['refresh_resume'] = array('type'=>'self','url'=>U('personal/resume_list'));
	    	...
	    	$data['complete_90'] = array('type'=>'self','url'=>U('personal/resume_list'));
	    	$data['complete_60'] = array('type'=>'self','url'=>U('personal/resume_list'));
	     ...
	     * 获取任务链接地址(触屏)
	     */
	    public function task_url_mobile($utype=1){
	    	$data['sign'] = array('type'=>'ajax','url'=>U('Members/sign_in'));
	    	$data['upload_logo'] = array('type'=>'self','url'=>U('Company/com_info'));
	    	$data['upload_companyimg'] = array('type'=>'self','url'=>U('Company/com_img'));
	    	...
	    	$data['user_info'] = array('type'=>'self','url'=>U('personal/user_info'));
	    	$data['upload_avatar'] = array('type'=>'self','url'=>U('personal/user_info'));
	    	$data['refresh_resume'] = array('type'=>'self','url'=>U('personal/resume_list'));
