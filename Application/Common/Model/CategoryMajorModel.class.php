...
class CategoryMajorModel extends Model
{
	...
	public function major_cache(){
		$major = array();
		$majorData = $this->field('id,parentid,categoryname')->order('parentid asc,category_order asc')->select();
	...
	public function major_data_cache(){
		$majorList = $this->order('category_order asc')->getfield('id,parentid,categoryname');
